...
import 'list02_products_n_e_w_model.dart';
export 'list02_products_n_e_w_model.dart';

class List02ProductsNEWWidget extends StatefulWidget {
  const List02ProductsNEWWidget({Key? key}) : super(key: key);

  @override
  _List02ProductsNEWWidgetState createState() =>
      _List02ProductsNEWWidgetState();
}

class _List02ProductsNEWWidgetState extends State<List02ProductsNEWWidget> {
  late List02ProductsNEWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => List02ProductsNEWModel());
