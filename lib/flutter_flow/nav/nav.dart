...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ListeningPageNEW',
          path: '/listeningPageNEW',
          builder: (context, params) => ListeningPageNEWWidget(
        ...
        FFRoute(
          name: 'List02ProductsNEW',
          path: '/list02ProductsNEW',
          builder: (context, params) => List02ProductsNEWWidget(),
        )
